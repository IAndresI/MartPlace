...
function slider(slider__item, slider__translateX, slider__button__next, slider__button__prev, slidesToShow = 1, responsive = false) {
  let slider_item = document.querySelectorAll(slider__item),
    ...
    SLIDE_WIDTH = document.querySelector(".product-item__item").offsetWidth,
    INNER_SLIDE_WIDTH = document.querySelector(".product-item__inner").offsetWidth;
  ...
  function adaptive(slidesShow) {
    let SLIDES = document.querySelectorAll(`.${slider_transitionx.parentElement.parentElement.parentElement.parentElement.getAttribute("class")} .slide-container`),
      INNER_SLIDE_WIDTH = document.querySelector(".product-item__inner").offsetWidth;
